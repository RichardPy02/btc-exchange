...
This project, realized for educational puroposes, regards building a cryptocurrency exchange platoform by using MongoDB and a web framework (in this case [Django](https://www.djangoproject.com/)).
